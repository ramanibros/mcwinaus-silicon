    ...
    return (
        <Container>
            ...
            >
                ...
                <p className="mb-0">
                    Proven methodology trusted by Townsville's top marine science institutes and research organizations.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Requirements gathering, Townsville competitor analysis, data audit</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Wireframes Townsville, mockups, SEO roadmap</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Agile sprints, data visualization, API integrations</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Go-live checklist, researcher training, 3 months free support</p>
                    </div>
                </div>
            </div>
