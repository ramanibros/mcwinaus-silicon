                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Townsville dominance:
                        </p>
                        <p><strong> Technical SEO Townsville: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Townsville, internal linking</li>
                            <li>Schema Markup – ResearchOrganization, Dataset, ScholarlyArticle schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Townsville – Google Business Profile, citations, Townsville suburb targeting (North Ward, Castle Hill, Currajong)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Townsville CDN – Cloudflare, AWS CloudFront edge locations</li>
                                <li>Image Optimization – WebP/AVIF scientific imagery, lazy loading, responsive charts</li>
                            ...
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Townsville</span>
                            </h2>
                            <p>Transparent Townsville web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$6,000 – $14,000</td>
                                            <td>3–5 weeks</td>
                                            <td>Research institutes, marine centers</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$15,000 – $30,000</td>
                                            <td>6–10 weeks</td>
                                            <td>University departments, projects</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Data Platform</strong></td>
                                            <td>$30,000 – $70,000+</td>
                                            <td>10–16 weeks</td>
                                            <td>Reef monitoring, oceanographic data</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise Research</strong></td>
                                            <td>$50,000 – $120,000</td>
                                            <td>14–24 weeks</td>
                                            <td>Multi-institution collaboration hubs</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Townsville keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
