...
const techData: Record<string, any[]> = {
  Frontend: [
    ...
    { icon: "logos:vue", name: "D3.js", desc: "Data visualization libraries" },
    { icon: "logos:angular-icon", name: "Vue.js", desc: "Lightweight & flexible UI development" },
  ],
  Backend: [
    ...
    { icon: "logos:nodejs-icon", name: "FastAPI", desc: "High-performance Python APIs" },
  ],
  Database: [
    { icon: "logos:postgresql", name: "PostGIS", desc: "Geospatial database extensions" },
    ...
    { icon: "logos:redis", name: "Elasticsearch", desc: "Full-text search & analytics" },
  ],
  Science: [
    { icon: "mdi:map-outline", name: "Leaflet.js", desc: "Interactive mapping libraries" },
    { icon: "mdi:layers-outline", name: "OpenLayers", desc: "Advanced GIS visualization" },
    { icon: "mdi:chart-line", name: "ThingsBoard IoT", desc: "IoT platform & dashboards" },
    { icon: "mdi:weather-cloudy", name: "NOAA APIs", desc: "Oceanographic data services" },
  ],
  Cloud: [
    ...
    { icon: "mdi:satellite", name: "Google Earth Engine", desc: "Geospatial analysis platform" },
      ...
      <div className="container">
        ...
        <div className="section-header text-center">
          ...
          <p
            ...
            style={{ opacity: 0 }}
          >
            Industry-leading tech stack powering Townsville's fastest scientific websites
          </p>
        </div>
