...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Townsville?',
        answer: (
            <>
                <p>
                    $6K-$120K+ based on complexity. Research sites $15K+, data platforms $30K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Townsville?',
        answer: (
            <>
                <p>
                    3-24 weeks. Institute sites 3-5 weeks, research platforms 14-24 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Townsville SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Townsville SEO – scientific optimization guaranteed.
                </p>
            </>
        ),
    },
    {
        question: 'Can you handle large scientific datasets?',
        answer: (
            <>
                <p>
                    Scalable databases, real-time visualization, API-first architecture for big data.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Townsville agencies?',
        answer: (
            <>
                <p>
                    Townsville-local team, marine science expertise, proven research platform results.
                </p>
            </>
        ),
    }
