            ...
            <Card className="bg-white border-primary shadow-sm px-4 px-lg-0" data-bs-theme="light">
                <Row className="align-items-center py-3">
                    <Col xl={5} md={6} className="offset-lg-1 text-center text-md-start py-4 py-lg-5">
                        ...
                        <p>
                            <strong>Predictable delivery</strong> for all <strong>Townsville web development</strong> projects:
                        </p>
                        <ul className="list-unstyled mb-0">
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Basic Website: 3–5 weeks – Institute profiles, researcher directories
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Custom Website: 6–10 weeks – Grant portals, project showcases
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Data Platform: 10–16 weeks – Monitoring dashboards, GIS applications
                            </li>
                            <li className="d-flex">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Enterprise System: 14–24 weeks – Research collaboration platforms
                            </li>
                        </ul>
                        <br/>
                        <p>
                            95% of Townsville projects delivered on-time or early.
                        </p>
                    </Col>
