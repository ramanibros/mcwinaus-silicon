...
const faqs: FaqType[] = [
    {
        ...
        answer: (
            <>
                <p>
                    $3K-$35K based on complexity. Small business sites $3K-7K, tourism $12K+.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p>
                    2-10 weeks. Business sites 2-3 weeks, booking systems 4-8 weeks.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p>
                    Every project includes comprehensive Sunshine Coast SEO – local optimization guaranteed.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p>
                    100% mobile-first design with fast loading for beachgoers and travellers.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p>
                    Local team, small business focus, tourism expertise, affordable packages.
                </p>
            </>
        ),
    }
