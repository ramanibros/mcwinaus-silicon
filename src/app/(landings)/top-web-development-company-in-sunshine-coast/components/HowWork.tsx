    ...
    return (
        <Container>
            ...
            >
                ...
                <p className="mb-0">
                    Proven methodology trusted by Sunshine Coast's small businesses and tourism operators.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Requirements gathering, Sunshine Coast competitor analysis, keyword research</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Wireframes Sunshine Coast, mockups, mobile-first layouts</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">WordPress build, booking integrations, SEO implementation</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Mobile testing, speed optimization, local SEO validation</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Go-live, Google My Business setup, 3 months free support</p>
                    </div>
                </div>
            </div>
