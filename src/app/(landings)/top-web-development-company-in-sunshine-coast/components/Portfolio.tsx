...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Noosa Heads accommodation operator with 3 properties</font><br/>' +
            '<font><strong>Challenge:</strong> Reliance on booking.com, poor mobile bookings, inconsistent branding</font><br/>' +
            '<font><strong>Solution:</strong> Custom WordPress booking site, Sunshine Coast SEO, mobile-first design</font><br/>' +
            '<font><strong>Results:</strong> +380% direct bookings, +260% organic traffic, 72% mobile conversion increase</font>' +
            '</div>',
        name: 'Sunshine Coast Tourism Success',
        role: 'Live: #1 Google for "Noosa Heads holiday accommodation" | 14K monthly visits',
        bg: testi1,
    }
]
