                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Sunshine Coast dominance:
                        </p>
                        <p><strong> Technical SEO Sunshine Coast: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Sunshine Coast, internal linking</li>
                            <li>Schema Markup – LocalBusiness, Restaurant, TouristAttraction schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Sunshine Coast – Google Business Profile, citations, suburb targeting (Noosa Heads, Coolum Beach, Caloundra)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Sunshine Coast CDN – Cloudflare caching, image optimization</li>
                                <li>Mobile Speed Optimization – AMP pages, responsive images, minimal JavaScript</li>
                                <li>Google PageSpeed Focus – 95+ desktop/mobile scores guaranteed</li>
                                <li>Schema Implementation – Local business structured data for rich snippets</li>
                            </ul>
                            <p className="text-center mb-4"></p>
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Sunshine Coast</span>
                            </h2>
                            <p>Transparent Sunshine Coast web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$3,000 – $7,000</td>
                                            <td>2–3 weeks</td>
                                            <td>Local trades, cafes, service businesses</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$7,000 – $15,000</td>
                                            <td>3–6 weeks</td>
                                            <td>Tourism operators, professional services</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Booking Website</strong></td>
                                            <td>$12,000 – $25,000</td>
                                            <td>4–8 weeks</td>
                                            <td>Accommodation, tour companies</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Ecommerce Store</strong></td>
                                            <td>$15,000 – $35,000</td>
                                            <td>6–10 weeks</td>
                                            <td>Local product sellers, gift shops</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Sunshine Coast keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
