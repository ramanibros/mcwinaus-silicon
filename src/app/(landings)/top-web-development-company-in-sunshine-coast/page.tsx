...
import Subscribe from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Subscribe";
import Footer from "@/components/common/Footer";
import Faqs from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Faqs";
import HowWork from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/HowWork";
import Solutions from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Solutions";
import Portfolio from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Portfolio";
import Description from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Description";
import Link from "next/link";
import IconifyIcon from "@/components/IconifyIcon";
import Technology from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/Technology";
import ProjectTimeline from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/ProjectTimeline";
import About from "@/app/(landings)/top-web-development-company-in-sunshine-coast/components/About";
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "McWIN iTECH - Web Development Sunshine Coast",
            },
        ],
    },
