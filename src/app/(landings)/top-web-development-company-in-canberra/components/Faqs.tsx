...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Canberra?',
        answer: (
            <>
                <p>
                    $5K-$150K+ based on classification level. Compliance systems $30K+, enterprise $60K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Canberra?',
        answer: (
            <>
                <p>
                    2-28 weeks. Simple sites 2-5 weeks, classified systems 16-28 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Canberra SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Canberra SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your platforms IRAP certified?',
        answer: (
            <>
                <p>
                    Built to PROTECTED level with IRAP assessment pathway and ASD Essential Eight compliance.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Canberra agencies?',
        answer: (
            <>
                <p>
                    Canberra-local team, government contracting expertise, proven IRAP compliance results.
                </p>
            </>
        ),
    }
