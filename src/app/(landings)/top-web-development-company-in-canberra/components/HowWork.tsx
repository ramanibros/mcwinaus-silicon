    ...
    return (
        <Container>
            ...
            >
                ...
                <p className="mb-0">
                    Proven methodology trusted by Canberra's top government contractors and cyber security firms.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Requirements gathering, Canberra competitor analysis, IRAP assessment</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Wireframes Canberra, mockups, SEO roadmap, security architecture</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Agile sprints, daily standups, client previews, security gates</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Penetration testing, SEO validation, performance tuning, compliance audit</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Go-live checklist, knowledge transfer, 6 months compliance support</p>
                    </div>
                </div>
            </div>
