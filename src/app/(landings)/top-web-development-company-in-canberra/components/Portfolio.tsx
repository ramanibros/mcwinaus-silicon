...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Canberra-based defence systems integrator</font><br/>' +
            '<font><strong>Challenge:</strong> Manual PSPF compliance, failed security audits, poor tender conversion</font><br/>' +
            '<font><strong>Solution:</strong> PSPF compliance portal, AusTender integration, IRAP PROTECTED certification</font><br/>' +
            '<font><strong>Results:</strong> +420% tender win rate, 100% audit compliance, IRAP certification in 4 months</font>' +
            '</div>',
        name: 'Canberra Government Contractor Success',
        role: 'Live: #1 Google for "PSPF compliance Canberra" | 28K monthly visits',
        bg: testi1,
    }
]
