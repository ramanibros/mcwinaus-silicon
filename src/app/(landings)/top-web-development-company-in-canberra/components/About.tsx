                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Canberra dominance:
                        </p>
                        <p><strong> Technical SEO Canberra: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Canberra, internal linking</li>
                            <li>Schema Markup – GovernmentOrganization, CybersecurityCompany schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Canberra – Google Business Profile, citations, Canberra suburb targeting (Fyshwick, Brindabella Park, Symonston)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Canberra CDN – Cloudflare, AWS CloudFront edge locations</li>
                            ...
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Canberra</span>
                            </h2>
                            <p>Transparent Canberra web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$5,000 – $15,000</td>
                                            <td>2–5 weeks</td>
                                            <td>Small contractors, consultancies</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$15,000 – $35,000</td>
                                            <td>6–10 weeks</td>
                                            <td>Mid-tier government contractors</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Compliance Portal</strong></td>
                                            <td>$30,000 – $75,000+</td>
                                            <td>10–16 weeks</td>
                                            <td>PSPF systems, security clearances</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise System</strong></td>
                                            <td>$60,000 – $150,000</td>
                                            <td>16–28 weeks</td>
                                            <td>Large primes, SOC platforms</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Canberra keyword research, 3 months support, IRAP compliance roadmap.
                            </p>
                        </div>
                    </Col>
                </Row>
