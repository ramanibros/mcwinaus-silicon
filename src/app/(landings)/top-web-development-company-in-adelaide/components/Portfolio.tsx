...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Adelaide-based defence systems integrator</font><br/>' +
            '<font><strong>Challenge:</strong> Manual compliance reporting, poor subcontractor collaboration, audit failures</font><br/>' +
            '<font><strong>Solution:</strong> Secure project portal, automated compliance reporting, encrypted file sharing</font><br/>' +
            '<font><strong>Results:</strong> +350% audit compliance, +240% subcontractor efficiency, zero security incidents in 6 months</font>' +
            '</div>',
        name: 'Adelaide Defence Success',
        role: 'Live: #1 Google for "defence compliance software Adelaide" | 15K monthly visits',
        bg: testi1,
    }
]
