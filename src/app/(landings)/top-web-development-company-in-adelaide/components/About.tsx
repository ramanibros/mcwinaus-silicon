                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Adelaide dominance:
                        </p>
                        <p><strong> Technical SEO Adelaide: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Adelaide, internal linking</li>
                            <li>Schema Markup – LocalBusiness, MedicalOrganization, EducationalOrganization schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Adelaide – Google Business Profile, citations, Adelaide suburb targeting (Mawson Lakes, West Lakes, Tea Tree Gully)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Adelaide CDN – Cloudflare, AWS CloudFront edge locations</li>
                            ...
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Adelaide</span>
                            </h2>
                            <p>Transparent Adelaide web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$5,000 – $10,000</td>
                                            <td>2–4 weeks</td>
                                            <td>Small education providers, clinics</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$10,000 – $25,000</td>
                                            <td>4–8 weeks</td>
                                            <td>Healthtech startups, training orgs</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Compliance Portal</strong></td>
                                            <td>$25,000 – $60,000+</td>
                                            <td>8–14 weeks</td>
                                            <td>Defence contractors, hospitals</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise System</strong></td>
                                            <td>$50,000 – $120,000</td>
                                            <td>12–24 weeks</td>
                                            <td>Universities, defence primes</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Adelaide keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
