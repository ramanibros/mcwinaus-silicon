            ...
            <Card className="bg-white border-primary shadow-sm px-4 px-lg-0" data-bs-theme="light">
                <Row className="align-items-center py-3">
                    <Col xl={5} md={6} className="offset-lg-1 text-center text-md-start py-4 py-lg-5">
                        ...
                        <p>
                            <strong>Predictable delivery</strong> for all <strong>Adelaide web development</strong> projects:
                        </p>
                        <ul className="list-unstyled mb-0">
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Basic Website: 2–4 weeks – Institutional sites, clinic websites
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Custom Website: 4–8 weeks – Healthtech apps, training platforms
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Compliance Portal: 8–14 weeks – Defence systems, patient portals
                            </li>
                            <li className="d-flex">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Enterprise System: 12–24 weeks – LMS platforms, hospital systems
                            </li>
                        </ul>
                        <br/>
                        <p>
                            90% of Adelaide projects delivered on-time or early.
                        </p>
                    </Col>
