...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Adelaide?',
        answer: (
            <>
                <p>
                    $5K-$120K+ based on complexity. Defence/healthtech $25K+, enterprise $50K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Adelaide?',
        answer: (
            <>
                <p>
                    2-24 weeks. Simple sites 2-4 weeks, compliance systems 12-24 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Adelaide SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Adelaide SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your defence platforms security compliant?',
        answer: (
            <>
                <p>
                    Built to AUSTEO/RESTREVAL standards with PSPF compliance and encryption.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Adelaide agencies?',
        answer: (
            <>
                <p>
                    Adelaide-local team, defence/healthtech/education expertise, proven compliance results.
                </p>
            </>
        ),
    }
