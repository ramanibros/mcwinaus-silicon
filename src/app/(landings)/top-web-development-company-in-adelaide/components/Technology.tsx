...
const techData: Record<string, any[]> = {
  ...
  Backend: [
    ...
    { icon: "logos:php", name: "PHP Symfony", desc: "Robust PHP framework" },
  ],
  Database: [
    ...
    { icon: "logos:oracle", name: "Oracle", desc: "High-availability databases" },
  ],
  Compliance: [
    { icon: "logos:azure", name: "Azure Government", desc: "Government cloud services" },
    { icon: "logos:aws", name: "AWS GovCloud", desc: "Secure government cloud" },
    { icon: "mdi:shield-lock", name: "Encryption Libraries", desc: "End-to-end encryption" },
    { icon: "mdi:certificate", name: "PSPF Compliance", desc: "Australian security standards" },
  ],
  Cloud: [
    { icon: "logos:aws", name: "AWS Sydney", desc: "Scalable cloud infrastructure" },
    { icon: "logos:microsoft-azure", name: "Azure Australia Central", desc: "Enterprise cloud services" },
      ...
      <div className="container">
        ...
        <div className="section-header text-center">
          ...
          <p
            ...
            style={{ opacity: 0 }}
          >
            Industry-leading tech stack powering Adelaide's fastest websites
          </p>
        </div>
