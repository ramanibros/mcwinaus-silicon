...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Gold Coast?',
        answer: (
            <>
                <p>
                    $5K-$50K+ based on complexity. Lifestyle sites $10K-25K, ecommerce $20K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Gold Coast?',
        answer: (
            <>
                <p>
                    2-12 weeks. Portfolios 2-4 weeks, ecommerce/agency platforms 6-12 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Gold Coast SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Gold Coast SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your ecommerce stores mobile-optimized?',
        answer: (
            <>
                <p>
                    Built mobile-first with AMP pages, PWA technology for Gold Coast beach lifestyle.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Gold Coast agencies?',
        answer: (
            <>
                <p>
                    Gold Coast-local team, lifestyle brand expertise, proven digital marketing results.
                </p>
            </>
        ),
    }
