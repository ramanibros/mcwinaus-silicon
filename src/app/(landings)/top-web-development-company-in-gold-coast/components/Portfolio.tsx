...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Gold Coast premium activewear brand</font><br/>' +
            '<font><strong>Challenge:</strong> Low ecommerce conversion rates, poor mobile experience, fragmented social proof</font><br/>' +
            '<font><strong>Solution:</strong> Shopify Plus + headless commerce, Gold Coast SEO strategy, influencer integration</font><br/>' +
            '<font><strong>Results:</strong> +410% conversion rate, +290% organic traffic, 3.2x average order value in 3 months</font>' +
            '</div>',
        name: 'Gold Coast Lifestyle Brand Success',
        role: 'Live: #1 Google for "sustainable activewear Gold Coast" | 32K monthly visits',
        bg: testi1,
    }
]
