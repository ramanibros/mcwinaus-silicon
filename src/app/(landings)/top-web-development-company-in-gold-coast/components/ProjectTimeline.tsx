            ...
            <Card className="bg-white border-primary shadow-sm px-4 px-lg-0" data-bs-theme="light">
                <Row className="align-items-center py-3">
                    <Col xl={5} md={6} className="offset-lg-1 text-center text-md-start py-4 py-lg-5">
                        ...
                        <p>
                            <strong>Predictable delivery</strong> for all <strong>Gold Coast web development</strong> projects:
                        </p>
                        <ul className="list-unstyled mb-0">
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Basic Website: 2–4 weeks – Portfolio sites, service pages
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Custom Website: 4–8 weeks – Influencer platforms, agency showcases
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Ecommerce Platform: 6–12 weeks – Shopify Plus, subscription commerce
                            </li>
                            <li className="d-flex">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Agency Platform: 4–10 weeks – Client portals, marketing dashboards
                            </li>
                        </ul>
                        <br/>
                        <p>
                            90% of Gold Coast projects delivered on-time or early.
                        </p>
                    </Col>
