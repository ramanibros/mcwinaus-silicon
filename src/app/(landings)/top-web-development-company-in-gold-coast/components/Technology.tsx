...
const techData: Record<string, any[]> = {
  Frontend: [
    ...
    { icon: "logos:webflow", name: "Webflow", desc: "No-code visual development" },
  ...
  Backend: [
    ...
    { icon: "logos:shopify", name: "Shopify Liquid", desc: "Ecommerce template language" },
    { icon: "logos:strapi", name: "Strapi CMS", desc: "Headless content management" },
    { icon: "logos:sanity", name: "Sanity", desc: "Developer-first CMS" },
  ],
  Database: [
    ...
    { icon: "logos:shopify", name: "Shopify Storefront API", desc: "Headless ecommerce data" },
  ],
  Marketing: [
    { icon: "logos:google-tag-manager", name: "Google Tag Manager", desc: "Marketing tag management" },
    { icon: "logos:facebook", name: "Facebook Pixel", desc: "Social media tracking" },
    { icon: "logos:klaviyo", name: "Klaviyo", desc: "Email & SMS marketing" },
    { icon: "logos:hotjar", name: "Hotjar", desc: "User behavior analytics" },
  ],
  Cloud: [
    { icon: "logos:aws", name: "AWS Sydney", desc: "Scalable cloud infrastructure" },
    { icon: "logos:vercel-icon", name: "Vercel", desc: "Next.js hosting platform" },
    { icon: "logos:netlify", name: "Netlify", desc: "JAMstack deployment" },
    { icon: "logos:cloudflare", name: "Cloudflare Workers", desc: "Edge computing & CDN" },
  ],
};
      ...
      <div className="container">
        ...
        <div className="section-header text-center">
          ...
          <p
            ...
            style={{ opacity: 0 }}
          >
            Industry-leading tech stack powering Gold Coast's fastest websites
          </p>
        </div>
