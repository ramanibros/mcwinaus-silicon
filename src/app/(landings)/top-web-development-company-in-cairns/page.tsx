...
export const metadata = {
    ...
    keywords: [
        ...
        "Web Design Cairns",
        "Hospitality Web Development Cairns",
        "Restaurant Website Development Cairns",
        "Hotel Website Design Cairns",
        "Cairns Web Development Agency",
        "Professional Website Services Cairns",
    ],
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "McWIN iTECH - Web Development Cairns",
            },
        ],
    },
        ...
        <>
            ...
            <IconifyIcon icon="bx:chevrons-right"/>
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            Top Web Development Company in Cairns for Hospitality
                        </li>
                    </ol>
                </nav>
                <div
