    ...
    return (
        <Container>
            ...
            >
                ...
                <p className="mb-0">
                    Proven methodology trusted by Brisbane's top tourism operators, logistics firms, and real estate agencies.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Requirements gathering, Brisbane competitor analysis, technical audit</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Wireframes Brisbane, mockups, SEO roadmap</p>
                    </div>
                </div>
