...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Brisbane tour operator with 5 properties</font><br/>' +
            '<font><strong>Challenge:</strong> Manual booking system, poor mobile experience, low direct bookings</font><br/>' +
            '<font><strong>Solution:</strong> Custom booking platform, Brisbane SEO strategy, mobile PWA</font><br/>' +
            '<font><strong>Results:</strong> +320% direct bookings, +210% organic traffic, 68% mobile conversion increase in 3 months</font>' +
            '</div>',
        name: 'Brisbane Tourism Success',
        role: 'Live: #1 Google for "Gold Coast tours from Brisbane" | 18K monthly visits',
        bg: testi1,
    }
]
