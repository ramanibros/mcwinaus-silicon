...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Brisbane?',
        answer: (
            <>
                <p>
                    $5K-$75K+ based on complexity. Tourism sites $5K-20K, logistics/real estate $25K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Brisbane?',
        answer: (
            <>
                <p>
                    2-16 weeks. Simple sites 2-4 weeks, enterprise systems 8-16 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Brisbane SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Brisbane SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your booking systems scalable for peak seasons?',
        answer: (
            <>
                <p>
                    Built with auto-scaling cloud infrastructure, load balancing for Brisbane tourism peaks.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Brisbane agencies?',
        answer: (
            <>
                <p>
                    Brisbane-local team, tourism/logistics/real estate expertise, proven industry results.
                </p>
            </>
        ),
    }
