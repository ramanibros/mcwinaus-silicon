                ...
                <Col md={6} className="order-md-2">
                    <div className="pe-xl-5 me-md-2 me-lg-4">
                        ...
                        <p className="mb-3 mb-sm-4">
                            Paid advertising strategies designed to deliver measurable commercial outcomes rather than
                            surface-level metrics. Our Perth-based team focuses on cost control, conversion quality, and
