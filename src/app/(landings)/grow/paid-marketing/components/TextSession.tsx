...
import image02 from "@/assets/img/grow-service/Grow_S1.jpg";
        ...
        <Row className="align-items-center py-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="PPC Growth" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                PPC Built for Sustainable Profitability
              </h2>

              <p ref={paraRef}>
                Paid advertising strategies designed to deliver measurable
                commercial outcomes rather than surface-level metrics. Our
                Perth-based team focuses on cost control, conversion quality, and
                scalable growth across Australian markets.
              </p>
                ...
                {[
                  {
                    ...
                    text: "Nationwide Auction Domination",
                  },
                  {
                    icon: <HiOutlineFire />,
                    text: "Zero Budget Burn",
                  },
                  {
                    icon: <HiOutlineTrendingUp />,
                    text: "Scale-Ready Campaigns",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
