                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    High-intent Google Ads campaigns built around keyword strategy, ad relevance, and
                                    bidding control. Designed to improve conversion efficiency while keeping cost per
                                    acquisition within sustainable limits.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Paid campaigns across Facebook and Instagram using audience segmentation, creative
                                    testing, and retargeting. Focused on generating qualified leads and supporting
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Microsoft Advertising campaigns across Bing and partner networks, providing access
                                    to additional high-intent audiences—often at lower competition and cost than Google
                                    Search.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Product-based advertising across Google Shopping and Meta catalogue formats. Feed
                                    structure, bidding logic, and product segmentation are optimised to support higher
                                    purchase intent and average order value.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Intent-aligned Youtube advertising designed to support awareness, remarketing, and
                                    mid-funnel engagement. Campaigns are structured to balance reach, cost efficiency,
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Unified optimisation across Google, Meta, and Microsoft platforms. Budget
                                    allocation, performance review, and bid adjustments are managed holistically to
                                    reduce waste and improve overall return.
                                </p>
                            </div>
                        </div>
                    </div>
