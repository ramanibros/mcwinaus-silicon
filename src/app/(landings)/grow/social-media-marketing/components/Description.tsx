    ...
    const steps = [
        {
            ...
            title: "Instagram Growth Systems",
            description: "Instagram growth strategies using Reels, Stories, and carousel content aligned with Australian audience behaviour. Designed to increase reach, profile engagement, and inbound enquiries through consistent, relevant content."
        },
        {
            icon: <SiFacebook size={24} />,
            title: "Facebook Lead Generation",
            description: "Facebook lead generation campaigns using audience segmentation, retargeting, and automated messaging. Built to improve lead quality and reduce cost inefficiencies through better targeting and qualification."
        },
        {
            icon: <SiLinkedin size={24} />,
            title: "LinkedIn B2B Domination",
            description: "LinkedIn strategies for B2B brands focused on thought leadership, employer advocacy, and relationship-driven growth. Designed to support higher-quality conversations and longer-term sales opportunities."
        },
        {
            icon: <FiVideo size={24} />,
            title: "Reel Viral Systems",
            description: "Trending audio and Aussie-humour hooks drive up to 5× more video views. User-generated content campaigns convert viewers into paying customers through social proof multiplication."
        },
        {
            icon: <FiCalendar size={24} />,
            title: "Content Calendar Mastery",
            description: "60-day platform-specific posting schedules maintain a consistent brand voice. Peak-time publishing maximises engagement without daily manual management."
        },
        {
            icon: <FiBarChart2 size={24} />,
            title: "Social Analytics & Optimisation",
            description: "ROAS tracking, audience insights, and competitor benchmarking. Weekly strategy pivots ensure continuous performance improvement and maximised ad spend efficiency."
        }
    ];
                            ...
                            >
                                ...
                                <CardBody className="position-relative z-2 p-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        Complete social media marketing solution for businesses ready to build brand presence, drive engagement, and generate quality leads.
                                    </p>
                                    
                                    <div className="mb-4">
                                        {[
                                            { icon: <MdOutlineAnalytics />, text: "Strategy & Planning" },
                                            { icon: <MdOutlineDescription />, text: "Content Creation & Publishing" },
                                            { icon: <MdOutlineGroup />, text: "Community & Engagement" },
                                            { icon: <MdOutlineTrackChanges />, text: "Analytics & Reporting" },
                                            { icon: <MdOutlineChat />, text: "Monthly Strategy Calls" }
                                        ].map((item, index) => (
