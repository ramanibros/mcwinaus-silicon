...
import image02 from "@/assets/img/grow-service/Grow_S4.jpg";
        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="Social Revenue Machine" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Australia's Social Revenue Machine
              </h2>

              <p ref={paraRef}>
                Social that drives real sales—not likes and follows. What makes us different: Perth locals
                genuinely care about your revenue per post. Proof, not promises, 67% ROI guaranteed.
              </p>

              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:account-group-outline", // For Nationwide Audience Reach
                    text: "Nationwide Audience Reach",
                  },
                  {
                    icon: "mdi:cash-remove", // For Zero Wasted Ad Spend
                    text: "Zero Wasted Ad Spend",
                  },
                  {
                    icon: "mdi:chart-timeline-variant", // For Algorithm-Proof Strategies
                    text: "Algorithm-Proof Strategies",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
