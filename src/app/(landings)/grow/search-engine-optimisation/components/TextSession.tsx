...
import image02 from "@/assets/img/grow-service/Grow_S3.jpg";
        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="SEO Revenue Engine" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Australia's SEO Revenue Engine
              </h2>

              <p ref={paraRef}>
                Monthly SEO reporting with clear insights into rankings, traffic trends, and performance
                indicators. Reports are designed to support informed decisions and continuous optimisation
              ...
              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:map-search-outline", // For Nationwide Search Mastery
                    text: "Nationwide Search Mastery",
                  },
                  {
                  ...
                  {
                    icon: "mdi:shield-check-outline", // For Algorithm-Proof Foundation
                    text: "Algorithm-Proof Foundation",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
