                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Local SEO strategies focused on improving visibility in Google Business Profiles and
                                    location-based searches. Optimised listings, consistent citations, and location
                                    pages help increase relevant local enquiries and in-store visits.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Comprehensive technical SEO audits covering site speed, mobile usability, indexing,
                                    and structured data. We address Core Web Vitals and technical barriers that impact
                                    crawlability, rankings, and user experience.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Content optimisation strategies aligned with search intent, including service pages,
                                    supporting content, and internal linking. Designed to improve organic visibility
                                    while guiding users towards meaningful actions.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Ethical link-building campaigns focused on acquiring relevant, high-quality
                                    Australian backlinks. Strategic outreach supports domain authority growth and
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Conversion rate optimisation for organic traffic, focusing on page structure, calls
                                    to action, and trust signals—ensuring increased visibility translates into
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Monthly SEO reporting with clear insights into rankings, traffic trends, and
                                    performance indicators. Reports are designed to support informed decisions and
                                    continuous optimisation rather than vanity metrics.
                                </p>
                            </div>
                        </div>
                    </div>
