            ...
            >
              ...
              {convertWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Performance-led search advertising built in Perth for Australian businesses that need
                        predictable, scalable returns. We manage paid search campaigns with a focus on intent,
                        efficiency, and measurable revenue—not wasted spend.
                    </p>
