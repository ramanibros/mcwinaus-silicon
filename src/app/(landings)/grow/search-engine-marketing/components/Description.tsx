                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    High-intent Google Search campaigns targeting users actively looking for your
                                    products or services. Keyword strategy, ad copy, and bidding are structured to
                                    maximise return while controlling cost per acquisition.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Optimised Google Shopping campaigns including product feed structuring, bidding
                                    strategy, and performance monitoring—designed to improve visibility and efficiency
                                    for Australian eCommerce businesses.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Remarketing strategies targeting previous visitors, abandoned carts, and high-intent
                                    users. Designed to recover lost opportunities and improve conversion efficiency
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    End-to-end conversion tracking setup including GA4, enhanced conversions, and event
                                    tracking—ensuring accurate measurement of leads, sales, and campaign performance.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Data-driven bidding strategies such as Target ROAS and Conversion Value
                                    optimisation, aligned with your business goals and budget efficiency requirements.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Ongoing campaign optimisation including keyword refinement, bid adjustments, and
                                    performance review. Campaigns are refined regularly to adapt to market changes and
                                    maintain efficiency.
                                </p>
                            </div>
                        </div>
