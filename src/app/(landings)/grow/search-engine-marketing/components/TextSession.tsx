...
import image02 from "@/assets/img/grow-service/Grow_S2.jpg";
        ...
        <Row className="align-items-center py-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="Paid Search for Sustainable Profit" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Paid Search Built for Sustainable Profit
              </h2>

              <p ref={paraRef}>
                Paid search campaigns designed to deliver measurable commercial outcomes rather than vanity
                metrics. Our Perth-based team focuses on intent-driven traffic, controlled spend, and clear
              ...
              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:search-web", // For Nationwide search campaign delivery
                    text: "Nationwide search campaign delivery",
                  },
                  {
                    icon: "mdi:chart-line", // For Reduced wasted ad spend
                    text: "Reduced wasted ad spend",
                  },
                  {
                    icon: "mdi:arrow-expand-vertical", // For Scalable paid media structures
                    text: "Scalable paid media structures",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
