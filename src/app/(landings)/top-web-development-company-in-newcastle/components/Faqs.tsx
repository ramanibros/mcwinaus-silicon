...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Newcastle?',
        answer: (
            <>
                <p>
                    $5K-$90K+ based on complexity. Industrial sites $12K+, B2B platforms $25K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Newcastle?',
        answer: (
            <>
                <p>
                    2-20 weeks. Business sites 2-4 weeks, enterprise systems 12-20 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Newcastle SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Newcastle SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your platforms ERP-ready for manufacturing?',
        answer: (
            <>
                <p>
                    Built with API integrations for MYOB, Xero, SAP Business One connectivity.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Newcastle agencies?',
        answer: (
            <>
                <p>
                    Newcastle-local team, B2B industrial expertise, proven manufacturing results.
                </p>
            </>
        ),
    }
