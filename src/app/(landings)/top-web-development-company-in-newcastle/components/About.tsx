                    ...
                    <Col xs={12}>
                        <div className="pricing-section">
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Newcastle</span>
                            </h2>
                            <p>Transparent Newcastle web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$5,000 – $12,000</td>
                                            <td>2–4 weeks</td>
                                            <td>Small manufacturers, service providers</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$12,000 – $28,000</td>
                                            <td>4–8 weeks</td>
                                            <td>Industrial suppliers, engineering firms</td>
                                        </tr>
                                        <tr>
                                            <td><strong>B2B Platform</strong></td>
                                            <td>$25,000 – $55,000+</td>
                                            <td>8–12 weeks</td>
                                            <td>Wholesale portals, quoting systems</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise System</strong></td>
                                            <td>$45,000 – $90,000</td>
                                            <td>12–20 weeks</td>
                                            <td>ERP integrations, shop floor systems</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Newcastle keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
