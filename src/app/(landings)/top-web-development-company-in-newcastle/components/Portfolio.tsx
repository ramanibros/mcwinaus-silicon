...
import testi1 from '@/assets/img/top-web-development-company-in-melbourne/Melbourne-ecommerce.jpg';
...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Newcastle steel fabrication manufacturer</font><br/>' +
            '<font><strong>Challenge:</strong> Manual quoting process, poor B2B lead conversion, outdated product catalogue</font><br/>' +
            '<font><strong>Solution:</strong> Custom quoting platform, B2B ecommerce portal, Newcastle SEO strategy</font><br/>' +
            '<font><strong>Results:</strong> +360% RFQ conversion, +250% organic industrial traffic, 38% order value increase</font>' +
            '</div>',
        name: 'Newcastle Manufacturing Success',
        role: 'Live: #1 Google for "steel fabrication Newcastle" | 19K monthly visits',
        bg: testi1,
    }
]
