                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Perth dominance:
                        </p>
                        <p><strong> Technical SEO Perth: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Perth, internal linking</li>
                            <li>Schema Markup – LocalBusiness, Organization, MiningCompany schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Perth – Google Business Profile, citations, Perth suburb targeting (Welshpool, Malaga, Belmont)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Perth CDN – Cloudflare, AWS CloudFront edge locations</li>
                            ...
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Perth</span>
                            </h2>
                            <p>Transparent Perth web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$5,000 – $10,000</td>
                                            <td>2–4 weeks</td>
                                            <td>Small engineering firms, service providers</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$10,000 – $25,000</td>
                                            <td>4–8 weeks</td>
                                            <td>Mining contractors, industrial suppliers</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Project Portal</strong></td>
                                            <td>$20,000 – $50,000+</td>
                                            <td>6–12 weeks</td>
                                            <td>Mining operations, engineering consultancies</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise System</strong></td>
                                            <td>$40,000 – $100,000</td>
                                            <td>10–20 weeks</td>
                                            <td>Large mining companies, industrial tech</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Perth keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
