            ...
            <Card className="bg-white border-primary shadow-sm px-4 px-lg-0" data-bs-theme="light">
                <Row className="align-items-center py-3">
                    <Col xl={5} md={6} className="offset-lg-1 text-center text-md-start py-4 py-lg-5">
                        ...
                        <p>
                            <strong>Predictable delivery</strong> for all <strong>Perth web development</strong> projects:
                        </p>
                        <ul className="list-unstyled mb-0">
                            ...
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Custom Website: 4–8 weeks – Asset management, technical documentation
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Project Portal: 6–12 weeks – FIFO systems, safety compliance platforms
                            </li>
                            <li className="d-flex">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Enterprise System: 10–20 weeks – SCADA integration, ERP systems
                            </li>
                        </ul>
                        <br/>
                        <p>
                            90% of Perth projects delivered on-time or early.
                        </p>
                    </Col>
