...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Perth-based gold mining contractor</font><br/>' +
            '<font><strong>Challenge:</strong> Manual asset tracking, poor FIFO scheduling, safety compliance gaps</font><br/>' +
            '<font><strong>Solution:</strong> Custom asset management portal, mobile FIFO app, compliance dashboard</font><br/>' +
            '<font><strong>Results:</strong> +290% operational efficiency, +180% safety compliance, 42% downtime reduction in 4 months</font>' +
            '</div>',
        name: 'Perth Mining Success',
        role: 'Live: #1 Google for "mining asset management Perth" | 22K monthly visits',
        bg: testi1,
    }
]
