...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Perth?',
        answer: (
            <>
                <p>
                    $5K-$100K+ based on complexity. Mining portals $20K+, enterprise systems $40K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Perth?',
        answer: (
            <>
                <p>
                    2-20 weeks. Simple sites 2-4 weeks, industrial systems 10-20 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Perth SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Perth SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your platforms FIFO-ready for mining?',
        answer: (
            <>
                <p>
                    Built with offline-first architecture, mobile optimization for remote WA operations.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Perth agencies?',
        answer: (
            <>
                <p>
                    Perth-local team, mining/engineering expertise, proven industrial results.
                </p>
            </>
        ),
    }
