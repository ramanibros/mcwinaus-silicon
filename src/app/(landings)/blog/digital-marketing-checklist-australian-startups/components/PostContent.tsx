                ...
                <Col lg={12}>
                    <article style={{fontFamily: 'Arial, sans-serif', lineHeight: 1.7}}>
                        ...
                        <p style={{fontSize: '18px', marginBottom: '24px'}}>
                            ...
                            digital marketing is your lifeline for reaching new customers, building trust, and scaling
                            fast.
                        ...
                        {/* Section 1 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>1. Define Your Brand
                            Identity</h2>
                        <p style={{marginBottom: '16px'}}>Before you build campaigns, define who you are and what makes
                            you unique.</p>
                        ...
                        <p style={{fontStyle: 'italic', fontSize: '14px', color: '#64748b', marginBottom: '24px'}}>
                            Tip: Use your brand story to connect emotionally with your audience — especially on your
                            About page.
                        </p>

                        {/* Section 2 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>2. Set Clear Marketing
                            Goals</h2>
                        <ul style={{paddingLeft: '20px', marginBottom: '16px'}}>
                        ...
                        {/* Section 3 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>3. Build a
                            High-Converting Website</h2>
                        ...
                        {/* Section 4 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>4. Claim and Optimise
                        ...
                        {/* Section 5 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>5. Launch Your Social
                            Media Presence</h2>
                        <ul style={{paddingLeft: '20px', marginBottom: '16px'}}>
                            ...
                            <li style={{marginBottom: '8px'}}><strong>TikTok:</strong> Gen Z & trend-driven products
                            </li>
                        </ul>
                        <p style={{fontSize: '14px', color: '#64748b', marginBottom: '24px'}}>
                        ...
                        {/* Section 6 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>6. Develop a Content
                        ...
                        {/* Section 7 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>7. Master SEO for Organic
                            Growth</h2>
                        <ul style={{paddingLeft: '20px', marginBottom: '24px'}}>
                        ...
                        {/* Section 8 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>8. Run Paid Campaigns
                            (PPC & Social)</h2>
                        <ul style={{paddingLeft: '20px', marginBottom: '24px'}}>
                        ...
                        {/* Section 9 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>9. Email Marketing &
                            Automation</h2>
                        <ul style={{paddingLeft: '20px', marginBottom: '24px'}}>
                        ...
                        {/* Section 10 */}
                        <h2 style={{fontSize: '24px', fontWeight: 600, margin: '40px 0 16px'}}>10. Track, Measure &
                            Optimise</h2>
                        ...
                        <div style={{
                            ...
                            <p style={{fontWeight: 500}}>
                                👉 Ready to launch smarter? Contact <strong>McWIN iTECH</strong> and let’s build your
                                custom growth plan.
                            </p>
                        </div>
                    </article>
