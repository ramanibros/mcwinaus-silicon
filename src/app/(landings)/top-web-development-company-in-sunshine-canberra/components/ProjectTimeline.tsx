            ...
            <Card className="bg-white border-primary shadow-sm px-4 px-lg-0" data-bs-theme="light">
                <Row className="align-items-center py-3">
                    <Col xl={5} md={6} className="offset-lg-1 text-center text-md-start py-4 py-lg-5">
                        ...
                        <p>
                            <strong>Predictable delivery</strong> for all <strong>Canberra web development</strong> projects:
                        </p>
                        <ul className="list-unstyled mb-0">
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Basic Website: 2–5 weeks – Company profiles, capability statements
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Custom Website: 6–10 weeks – Tender platforms, service showcases
                            </li>
                            <li className="d-flex mb-2">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Compliance Portal: 10–16 weeks – PSPF systems, security management
                            </li>
                            <li className="d-flex">
                                <IconifyIcon icon="bx:check" className="text-primary lead me-2"/>
                                Enterprise System: 16–28 weeks – SOC platforms, classified systems
                            </li>
                        </ul>
                        <br/>
                        <p>
                            95% of Canberra projects delivered on-time or early.
                        </p>
                    </Col>
