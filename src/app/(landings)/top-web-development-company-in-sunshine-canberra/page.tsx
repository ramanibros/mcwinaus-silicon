...
export const metadata = {
    ...
    keywords: [
        ...
        "Web Design Canberra",
        "Custom Website Development Canberra",
        "Professional Website Services Canberra",
        "Responsive Web Design Canberra",
        "Canberra Web Development Agency",
        "Website Development Services Canberra",
    ],
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "McWIN iTECH - Web Development Canberra",
            },
        ],
    },
        ...
        <>
            ...
            <IconifyIcon icon="bx:chevrons-right"/>
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            Top Web Development Company in Canberra
                        </li>
                    </ol>
                </nav>
                <div
