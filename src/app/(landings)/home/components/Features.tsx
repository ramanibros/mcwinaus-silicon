...
const features: Feature[] = [
    ...
    },
    {
        ...
        description:
            (
                <>
                    Websites, eCommerce, Apps & Custom Software that <b>increase conversions without spending
                    thousands.</b>
                </>
            ),
        link: '/build',
                    ...
                    <Row className="gy-sm-4 gy-3 pb-xl-2 pb-md-0 pb-sm-2">
                        <Col md={6} xs={12}>
                            <p className="mb-0 fs-lg">
                                Get award-winning digital solutions with real insight into Perth's market. <b>We've got
                                you covered</b> from vision to long-term results.
                            </p>
                        </Col>
                    </Row>
                        ...
                        {features.map(feature => (
                            <Col key={feature.id}>
                                ...
                                <div className="animated-border-container h-100">
                                    <Card
                                        className="flex-column flex-sm-row flex-md-column flex-xxl-row align-items-center card-hover border-primary h-100 bg-white">
                                        <Image
                                        ...
                                        />
                                        <Card.Body
                                            className="text-center text-sm-start text-md-center text-xxl-start pb-3 pb-sm-2 pb-md-3 pb-xxl-2">
