...
import testi1 from '@/assets/img/top-web-development-company-in-geelong/Geelong-healthcare-illustration.png';
...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Geelong multi-doctor medical centre</font><br/>' +
            '<font><strong>Challenge:</strong> Manual phone bookings, poor online presence, high no-show rates</font><br/>' +
            '<font><strong>Solution:</strong> Custom appointment platform, Geelong SEO strategy, patient portal</font><br/>' +
            '<font><strong>Results:</strong> +390% online bookings, +270% organic traffic, 35% no-show reduction</font>' +
            '</div>',
        name: 'Geelong Healthcare Success',
        role: 'Live: #1 Google for "GP appointments Geelong" | 16K monthly visits',
        bg: testi1,
    }
]
