...
import layer from '@/assets/img/top-web-development-company-in-geelong/Geelong-Professional-Services-illustration.png';
...
const Hero = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // SplitText animation for "Powered by Geelong Expertise."
                    ...
                    <Col lg={5} md={6} className="text-center text-md-start order-md-1">
                        <h1 ref={titleRef} className="display-5 mb-lg-4">
                            ...
                            <span
                                ...
                                className="text-dark"
                            >
                                 Company in Geelong for Professional Services & Healthcare
                            </span>
                        </h1>
                    </Col>
                    ...
                    >
                        <div className="parallax mx-auto" style={{maxWidth: '356px'}}>
                            <div className="parallax-layer" data-depth="0.1">
                                <Image src={layer} alt="Geelong Professional Services & Healthcare Web Development"/>
                            </div>
                        </div>
                    </Col>
                </Row>
