...
const faqs: FaqType[] = [
    {
        ...
        answer: (
            <>
                <p>
                    $4K-$50K based on complexity. Practice sites $9K-20K, booking systems $15K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Geelong?',
        answer: (
            <>
                <p>
                    2-14 weeks. Business sites 2-4 weeks, healthcare platforms 6-10 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Geelong SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Geelong SEO – local optimization guaranteed.
                </p>
            </>
        ),
    },
    {
        question: 'Are your healthcare sites compliant?',
        answer: (
            <>
                <p>
                    Built to Australian privacy standards with secure patient data handling.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Geelong agencies?',
        answer: (
            <>
                <p>
                    Geelong-local team, healthcare expertise, proven professional services results.
                </p>
            </>
        ),
    }
