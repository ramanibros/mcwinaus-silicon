    ...
    return (
        <Container>
            ...
            >
                ...
                <p className="mb-0">
                    Proven methodology trusted by Geelong's top professional services firms and healthcare providers.
                </p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Requirements gathering, Geelong competitor analysis, compliance audit</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Wireframes Geelong, mockups, SEO roadmap</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Agile sprints, booking system integration, patient portal build</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Cross-browser testing, SEO validation, accessibility audit</p>
                    </div>
                </div>
