                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Geelong dominance:
                        </p>
                        <p><strong> Technical SEO Geelong: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Geelong, internal linking</li>
                            <li>Schema Markup – MedicalOrganization, LocalBusiness, ProfessionalService schemas</li>
                            <li>Core Web Vitals – LCP &lt;1.5s, FID &lt;50ms, CLS &lt;0.1</li>
                            <li>Local SEO Geelong – Google Business Profile, citations, Geelong suburb targeting (Westfield, Highton, East Geelong)</li>
                        </ul>
                    </Col>
                    <Col xl={6} md={7}
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <ul>
                                <li>Geelong CDN – Cloudflare, AWS CloudFront edge locations</li>
                                <li>Image Optimization – WebP/AVIF, lazy loading, responsive medical images</li>
                            ...
                            <h2 className="h1 pt-md-2 pt-lg-4 pt-xl-5 pb-md-3 pb-lg-4 mb-md-4">
                                Web Development Cost in <span ref={spanRef} className="text-gradient-primary">Geelong</span>
                            </h2>
                            <p>Transparent Geelong web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$4,000 – $9,000</td>
                                            <td>2–4 weeks</td>
                                            <td>Solo practitioners, small firms</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$9,000 – $20,000</td>
                                            <td>4–7 weeks</td>
                                            <td>Medical practices, law firms</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Booking Platform</strong></td>
                                            <td>$15,000 – $30,000</td>
                                            <td>6–10 weeks</td>
                                            <td>Multi-doctor clinics, consultancies</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise System</strong></td>
                                            <td>$25,000 – $50,000</td>
                                            <td>8–14 weeks</td>
                                            <td>Hospital departments, large firms</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Geelong keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
