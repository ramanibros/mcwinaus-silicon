...
const Solutions = () => {
    ...
    // Scale service theme with tech-focused colors
    const colorSchemes = [
        {
            // Blue theme for Integrations
            mainColor: '#3b82f6',
            hoverColor: '#2563eb',
        ...
        {
            // Purple theme for Advanced Scale Services
            mainColor: '#8b5cf6',
            hoverColor: '#7c3aed',
    ...
    return (
        <section 
            ...
            style={{
                ...
                backgroundImage: 'linear-gradient(1deg, rgb(195 221 255) 0%, rgb(131 145 251 / 0%) 100%)'
            }}
        >
            <Container className="py-lg-5">
                ...
                <div className="text-center mb-5 pb-lg-3">
                    ...
                    >
                        Expert scaling solutions crafted specifically for Perth businesses to accelerate growth and operational efficiency
                    </p>
                </div>
