            ...
            >
              ...
              {convertWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Conversion-focused websites built in Perth for Australian businesses that need performance, not
                        templates. We design and develop scalable, SEO-ready websites that prioritise speed, usability,
                        and measurable growth across all devices.
                    </p>
                    <Link
                        href="/contact"
