        ...
        <Col md={6} className="order-md-2">
          <div className="pe-xl-5 me-md-2 me-lg-4">
            ...
            <p className="mb-3 mb-sm-4">
              Websites built to support real business outcomes—not static brochure sites. Our Perth-based team focuses on speed, structure, and conversion fundamentals to ensure your website supports both visibility and revenue.
            </p>
            <ul className="list-unstyled mb-0">
              ...
              <li className="d-flex mb-2">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
                Conversion-first development approach
              </li>
              <li className="d-flex">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
