                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom WordPress development using lightweight, purpose-built themes focused on
                                    performance and flexibility. Our sites are optimised for fast load times, clean SEO
                                    structure, and custom functionality aligned with your business requirements.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    WooCommerce and Shopify website builds designed for smooth checkout experiences and
                                    operational efficiency. We integrate Australian payment gateways, inventory
                                    synchronisation, and cart recovery flows to reduce friction and improve purchase
                                    completion.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    High-conversion landing pages designed around a single, clear objective. Through
                                    layout optimisation, CTA placement, and behavioural insights, we help reduce bounce
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    SEO-first website architecture built with clean code, structured data, and
                                    performance best practices. This creates a strong technical foundation that supports
                                    sustainable search visibility and long-term ranking growth.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Ongoing website maintenance including monthly performance checks, security updates,
                                    and technical improvements—helping your site remain stable, secure, and aligned with
                                    evolving search standards.
                                </p>
                            </div>
                        </div>
                    </div>
