    ...
    const steps = [
        {
            ...
            description: "Custom WordPress development using lightweight, purpose-built themes focused on performance and flexibility. Our sites are optimised for fast load times, clean SEO structure, and custom functionality aligned with your business requirements."
        },
        {
            icon: <FiShoppingCart size={24} />,
            title: "eCommerce Website Builds",
            description: "WooCommerce and Shopify website builds designed for smooth checkout experiences and operational efficiency. We integrate Australian payment gateways, inventory synchronisation, and cart recovery flows to reduce friction and improve purchase completion."
        },
        {
            icon: <FiTrendingUp size={24} />,
            title: "Landing Page Optimisation",
            description: "High-conversion landing pages designed around a single, clear objective. Through layout optimisation, CTA placement, and behavioural insights, we help reduce bounce rates and improve lead quality."
        },
        {
            icon: <FiSmartphone size={24} />,
            title: "Mobile-Responsive Design",
            description: "Pixel-perfect performance across every device—driving up to 40% more mobile conversions with Aussie thumb-friendly navigation that ensures zero lost sales from phone and tablet users."
        },
        {
            icon: <FiSearch size={24} />,
            title: "SEO-First Architecture",
            description: "SEO-first website architecture built with clean code, structured data, and performance best practices. This creates a strong technical foundation that supports sustainable search visibility and long-term ranking growth."
        },
        {
            icon: <FiTool size={24} />,
            title: "Ongoing Performance Maintenance",
            description: "Ongoing website maintenance including monthly performance checks, security updates, and technical improvements—helping your site remain stable, secure, and aligned with evolving search standards."
        }
    ];
