...
import image02 from "@/assets/img/build-service/Build_S2.jpg";
        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="eCommerce Revenue Machine" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Australia's eCommerce Revenue Machine
              </h2>
              ...
              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:credit-card-check-outline", // For Nationwide Checkout Perfection
                    text: "Nationwide Checkout Perfection",
                  },
                  {
                    icon: "mdi:cart-arrow-down", // For Cart Recovery Automation
                    text: "Cart Recovery Automation",
                  },
                  {
