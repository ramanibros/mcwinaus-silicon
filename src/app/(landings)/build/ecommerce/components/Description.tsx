                                ...
                                <CardBody>
                                    ...
                                    <ul className="list-unstyled pb-3">
                                        <li className="d-flex align-items-center mb-2">
                                            ...
                                            eCommerce Strategy & Store Structure
                                        </li>
                                        <li className="d-flex align-items-center mb-2">
                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom WooCommerce store development with Australian payment gateways, optimised
                                    checkout flows, and inventory synchronisation. Built to reduce friction at purchase
                                    and support higher checkout completion through proven eCommerce best practices.
                                </p>
                            </div>
                        </div>
