    ...
    const steps = [
        {
            ...
            description: "Custom WooCommerce store development with Australian payment gateways, optimised checkout flows, and inventory synchronisation. Built to reduce friction at purchase and support higher checkout completion through proven eCommerce best practices."
        },
        {
            icon: <FiPackage size={24} />,
            title: "Shopify Plus Implementation",
            description: "Enterprise-grade Shopify Plus stores engineered for scale—driving up to 67% higher cart values through advanced customer segmentation, subscription flows, and Australian-ready shipping calculations."
        },
        {
            icon: <FiGrid size={24} />,
            title: "Product Catalogue Optimisation",
            description: "SEO-perfect category structures and conversion-driven product layouts—increasing add-to-cart rates by up to 40% using strategic merchandising and trust-building review systems."
        },
        {
            icon: <FiCreditCard size={24} />,
            title: "Payment Gateway Integration",
            description: "Afterpay, Zip, credit cards, and bank transfers—fully Australian compliant. Buy-now-pay-later options boost average order value by up to 30% with a frictionless checkout customers trust."
        },
        {
            icon: <FiSmartphone size={24} />,
            title: "Mobile Commerce Excellence",
            description: "Mobile-first, thumb-friendly shopping experiences converting up to 60% more phone users—ensuring zero lost sales across smartphones and tablets."
        },
        {
            icon: <FiTruck size={24} />,
            title: "Order Management Systems",
            description: "Automated fulfilment workflows, real-time stock alerts, and multi-warehouse syncing—cutting picking errors by up to 80% and keeping operations smooth during peak demand periods."
        }
    ];
                            ...
                            >
                                ...
                                <CardBody className="position-relative z-2 p-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        Complete eCommerce solution for businesses ready to launch high-conversion online stores that drive sales and customer loyalty.
                                    </p>
                                    
                                    <div className="mb-4">
                                        {[
                                            { icon: <MdOutlineAnalytics />, text: "eCommerce Strategy & Store Structure" },
                                            { icon: <MdOutlineDesignServices />, text: "Custom UI/UX Design" },
                                            { icon: <FiShoppingBag />, text: "eCommerce Development" },
                                            { icon: <MdOutlinePayment />, text: "Payments, Shipping & Tax Setup" },
                                            { icon: <MdOutlineInventory />, text: "Launch & Training" }
                                        ].map((item, index) => (
