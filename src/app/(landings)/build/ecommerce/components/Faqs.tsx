...
const faqs: FaqType[] = [
    ...
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Every major Aussie payment method included—Afterpay, Zip, credit cards. Buy-now-pay-later boosts
                    order value by up to 30%, with a checkout everyone trusts.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    100% national coverage with AusPost, StarTrack, and Sendle integration. Perth HQ powers
                    Darwin-to-Melbourne delivery perfection.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Daily sales obsession over launch parties. Conversion engineering is our focus, not just website
                    building—we genuinely care about your revenue.
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Real-time stock sync across all channels prevents overselling. Multi-warehouse ready for national
