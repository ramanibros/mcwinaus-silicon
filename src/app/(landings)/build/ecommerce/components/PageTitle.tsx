...
const PageTitle = () => {
    ...
    // Split "Stores That Sell" into individual words
    const storesWords = "Stores That Sell".split(' ');
            ...
            >
              ...
              {storesWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Performance-driven eCommerce stores built in Perth for Australian businesses that need
                        reliability, scalability, and sales efficiency. We design online stores focused on smooth
                        checkout, operational clarity, and long-term growth—not short-term hacks.
                    </p>
