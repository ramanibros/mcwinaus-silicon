        ...
        <Container>
            ...
            >
                <h2 ref={h2Ref} className="h1">
                    How Does It <span ref={spanRef} className="text-gradient-primary">Work?</span>
                </h2>
                <p className="mb-0">
            ...
            >
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">A quick discovery call maps your goals, Perth market gaps, and budget.
                            Custom roadmap ready in 48 hours.</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Interactive prototypes you approve before code. Visualise success—zero
                            guesswork.</p>
                    </div>
                </div>

                {/* STEP 3 - Lightning Build */}
                <div
                    ref={(el: HTMLDivElement | null) => {
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">2x faster delivery with daily updates. Mobile-first, SEO-ready,
                            conversion-optimised.</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="step-body">
                        ...
                        <p className="mb-0">Go live with confidence. 24/7 Perth support and performance guarantees are
                            included.</p>
                    </div>
                </div>
            </div>
