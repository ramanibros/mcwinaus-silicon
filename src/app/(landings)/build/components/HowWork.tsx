      ...
      >
        ...
        >
          ...
          <div className="step-body">
            ...
            <p className="mb-0">A quick discovery call maps your goals, Perth market gaps, and budget. Custom roadmap ready in 48 hours.</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="step-body">
            ...
            <p className="mb-0">Interactive prototypes you approve before code. Visualise success—zero guesswork.</p>
          </div>
        </div>
