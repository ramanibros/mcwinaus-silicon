        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="Mobile Revenue Machine" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Australia's Mobile Revenue Machine
              </h2>

              <p ref={paraRef}>
                Apps that actually make sales—not shelfware experiments. What makes us different: Perth
                locals genuinely care about your daily active users. Proof, not promises, 67% engagement
                guaranteed.
              </p>
              ...
              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:cellphone-check", // For Nationwide App Excellence
                    text: "Nationwide App Excellence",
                  },
                  {
                    icon: "mdi:rocket-launch-outline", // For Zero Launch Surprises
                    text: "Zero Launch Surprises",
                  },
                  {
                    icon: "mdi:server-network", // For Scale-Ready Architecture
                    text: "Scale-Ready Architecture",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
