            ...
            >
              ...
              {convertWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Scalable Mobile Apps built in Perth for Australian businesses that prioritise performance,
                        reliability, and user retention. We design and develop iOS and Android apps focused on smooth
                        user flows, measurable engagement, and long-term growth—without the risks of offshore
                        development.
                    </p>
                    <Link
                        href="/contact"
