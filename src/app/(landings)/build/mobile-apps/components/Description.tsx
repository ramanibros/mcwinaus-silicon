    ...
    const steps = [
        {
            ...
            description: "Native iOS app development using Swift and SwiftUI, aligned with Apple Human Interface Guidelines. Our apps are built for responsiveness, performance, and App Store readiness, with optional push notification systems to support repeat usage and retention."
        },
        {
            icon: <SiGoogleplay size={24} />,
            title: "Native Android App Development",
            description: "High-performance Kotlin apps crafted with Material Design 3 excellence—driving up to 67% higher engagement. Google Play optimised with deep linking and revenue-focused notification strategies."
        },
        {
            icon: <MdOutlineCode size={24} />,
            title: "Cross-Platform React Native",
            description: "Single codebase apps for iOS and Android—cutting development costs by up to 50% while maintaining native-level performance. Aussie localisation ensures consistent experiences across every device."
        },
        {
            icon: <FiSearch size={24} />,
            title: "App Store Optimisation (ASO)",
            description: "App Store Optimisation services including keyword research, metadata optimisation, and visual asset guidance—designed to improve app visibility and organic discovery across the App Store and Google Play."
        },
        {
            icon: <FiBell size={24} />,
            title: "Push Notification Systems",
            description: "Push notification systems with audience segmentation and timing strategies aligned to Australian user behaviour. Designed to encourage repeat engagement and support retention without relying solely on paid acquisition."
        },
        {
            icon: <FiBarChart2 size={24} />,
            title: "App Analytics & Iteration",
            description: "Firebase and CleverTap dashboards track every conversion path. Weekly performance reporting ensures continuous optimisation, smarter feature prioritisation, and compounding revenue growth."
        }
    ];
                            ...
                            >
                                ...
                                <CardBody className="position-relative z-2 p-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        Complete mobile app development solution for businesses ready to launch high-performance apps that drive engagement and user retention.
                                    </p>
                                    
                                    <div className="mb-4">
                                        {[
                                            { icon: <MdOutlineAnalytics />, text: "App Strategy & Planning" },
                                            { icon: <MdOutlineDesignServices />, text: "UI/UX Design" },
                                            { icon: <MdOutlineCode />, text: "Cross-platform (Flutter / React Native)" },
                                            { icon: <MdOutlineAppSettingsAlt />, text: "Backend & API Integration" },
                                            { icon: <MdOutlineStore />, text: "App Store Launch & Handover" }
                                        ].map((item, index) => (
