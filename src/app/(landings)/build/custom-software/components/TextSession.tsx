...
import image02 from "@/assets/img/build-service/Build_S1.jpg";
        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="Business Efficiency Engine" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              <h2 ref={titleRef}>
                Australia's Business Efficiency Engine
              </h2>

              <p ref={paraRef}>
                Software that actually saves money—not shelfware experiments. What makes us different: Perth
                locals genuinely care about your operations. Proof, not promises, 67% efficiency guaranteed.
              </p>

              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:office-building-cog", // For Nationwide Operations
                    text: "Nationwide Operations",
                  },
                  {
                    icon: "mdi:puzzle-check-outline", // For Zero Integration Headaches
                    text: "Zero Integration Headaches",
                  },
                  {
                    icon: "mdi:crystal-ball", // For Future-Proof Architecture
