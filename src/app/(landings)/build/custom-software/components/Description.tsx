                                ...
                                <CardBody>
                                    ...
                                    <ul className="list-unstyled pb-3">
                                        <li className="d-flex align-items-center mb-2">
                                            ...
                                            Software Strategy & Requirements
                                        </li>
                                        <li className="d-flex align-items-center mb-2">
                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom inventory management systems with real-time stock tracking across one or
                                    multiple locations. Automated alerts and reordering logic help reduce overselling,
                                    improve stock accuracy, and provide clearer cash-flow visibility.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom CRM configuration aligned with your sales process, customer lifecycle, and
                                    reporting needs. Designed to improve pipeline visibility, sales efficiency, and
                                    compliance with Australian data requirements.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Workflow automation tools that reduce repetitive manual tasks across teams. We
                                    integrate systems such as accounting, CRM, and inventory platforms to improve
                                    operational efficiency and reduce processing time.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom internal dashboards providing real-time visibility into key business metrics.
                                    Designed for management teams to monitor performance, identify trends, and make
                                    faster, data-informed decisions across devices.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Secure API integrations that connect existing business systems and reduce reliance
                                    on manual data entry. This improves data accuracy, saves time, and allows teams to
                                    work more efficiently across connected platforms.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom modules that extend existing SaaS platforms with missing or specialised
                                    functionality. This approach often costs significantly less than replacing core
                                    systems while delivering features tailored to your workflow.
                                </p>
                            </div>
                        </div>
                    </div>
