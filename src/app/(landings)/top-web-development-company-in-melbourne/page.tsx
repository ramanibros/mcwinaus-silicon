...
import Subscribe from "@/app/(landings)/top-web-development-company-in-melbourne/components/Subscribe";
import Footer from "@/components/common/Footer";
import Faqs from "@/app/(landings)/top-web-development-company-in-melbourne/components/Faqs";
import HowWork from "@/app/(landings)/top-web-development-company-in-melbourne/components/HowWork";
import Solutions from "@/app/(landings)/top-web-development-company-in-melbourne/components/Solutions";
import Portfolio from "@/app/(landings)/top-web-development-company-in-melbourne/components/Portfolio";
import Description from "@/app/(landings)/top-web-development-company-in-melbourne/components/Description";
import Link from "next/link";
import IconifyIcon from "@/components/IconifyIcon";
import Technology from "@/app/(landings)/top-web-development-company-in-melbourne/components/Technology";
import ProjectTimeline from "@/app/(landings)/top-web-development-company-in-melbourne/components/ProjectTimeline";
import About from "@/app/(landings)/top-web-development-company-in-melbourne/components/About";
...
export const metadata = {
    ...
    alternates: {
        canonical: "https://www.mcwinitech.com.au/top-web-development-company-in-melbourne/",
    },
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "McWIN iTECH - Web Development Melbourne",
            },
        ],
    },
        ...
        <>
            ...
            <IconifyIcon icon="bx:chevrons-right"/>
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            Top Web Development Company in Melbourne
                        </li>
                    </ol>
                </nav>
                <div
