...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Melbourne?',
        answer: (
            <>
                <p>
                    $5K-$50K+ based on complexity. Agency sites $5K-10K, Ecommerce $20K+, startups $15K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Melbourne?',
        answer: (
            <>
                <p>
                    2-12 weeks. Portfolios 2-4 weeks, Ecommerce/startups 6-12 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Melbourne SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Melbourne SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your Ecommerce solutions scalable?',
        answer: (
            <>
                <p>
                    Built with Shopify Plus, headless architecture, auto-scaling infrastructure for Melbourne growth.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Melbourne agencies?',
        answer: (
            <>
                <p>
                    Melbourne-local team, Ecommerce expertise, creative agency focus, proven startup results.
                </p>
            </>
        ),
    }
