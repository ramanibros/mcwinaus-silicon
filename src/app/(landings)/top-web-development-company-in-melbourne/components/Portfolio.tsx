...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Melbourne fashion Ecommerce brand</font><br/>' +
            '<font><strong>Challenge:</strong> Slow mobile checkout, poor SEO rankings, abandoned carts</font><br/>' +
            '<font><strong>Solution:</strong> Shopify Plus + Next.js, Melbourne SEO strategy, one-click checkout</font><br/>' +
            '<font><strong>Results:</strong> +280% conversion rate, +190% organic traffic, 52% cart recovery in 3 months</font>' +
            '</div>',
        name: 'Melbourne Ecommerce Success',
        role: 'Live: #2 Google for "sustainable fashion Melbourne" | 25K monthly visits',
        bg: testi1,
    }
]
