...
const Description = () => {
    ...
    const steps = [
        {
            icon: <MdOutlineBrush size={24} />,
            title: "Logo Design Mastery",
            description: "Custom logo design that reflects your brand's personality, values, and positioning. Built for clarity, recognition, and differentiation in competitive Australian markets."
        },
        {
            icon: <MdOutlineStyle size={24} />,
            title: "Visual Identity Systems",
            description: "Complete visual identity frameworks including colour palettes, typography, and design rules—ensuring consistency across every touchpoint and driving up to 67% higher engagement through cohesive, trust-building design."
        },
        {
            icon: <MdOutlineColorLens size={24} />,
            title: "Brand Style Guides",
            description: "Clear and practical brand style guides that ensure accurate implementation across teams and partners, supporting consistency as your business grows."
        },
        {
            icon: <MdOutlineImage size={24} />,
            title: "Icon & Illustration Sets",
            description: "Custom iconography and illustration sets designed to complement your brand identity across digital, print, and social platforms, improving clarity and visual cohesion."
        },
        {
            icon: <FiLayers size={24} />,
            title: "Digital Asset Packages",
            description: "Ready-to-use digital assets including social profile graphics, favicons, and app icons—allowing fast deployment while maintaining consistent brand standards."
        },
        {
            icon: <MdOutlineVideoLibrary size={24} />,
            title: "Brand Video & Motion Graphics",
            description: "Brand-led motion graphics, animations, and short-form video assets designed to capture attention and reinforce brand positioning across digital channels."
        }
    ];
                            ...
                            >
                                ...
                                <CardBody className="position-relative z-2 p-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        Complete brand design solution for businesses ready to scale and dominate their market with professional visual identity.
                                    </p>
                                    
                                    <div className="mb-4">
                                        {[
                                            { icon: <MdOutlineBrush />, text: "Primary + Secondary Logo Design" },
                                            { icon: <MdOutlinePalette />, text: "Colour Palette & Typography System" },
                                            { icon: <FiLayers />, text: "Visual Identity Guidelines" },
                                            { icon: <MdOutlineAnalytics />, text: "Brand Assets Starter Kit" },
                                            { icon: <MdOutlineVideoLibrary />, text: "Motion Graphics Templates" }
                                        ].map((item, index) => (
                                    ...
                                    <div className="text-center mt-4">
                                        <small className="text-muted">30-day satisfaction guarantee • Dedicated support</small>
                                    </div>
                                </CardBody>
                            </Card>
                        </div>
