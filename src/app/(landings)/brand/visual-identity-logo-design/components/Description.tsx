                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom logo design that reflects your brand's personality, values, and positioning.
                                    Built for clarity, recognition, and differentiation in competitive Australian
                                    markets.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Clear and practical brand style guides that ensure accurate implementation across
                                    teams and partners, supporting consistency as your business grows.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Custom iconography and illustration sets designed to complement your brand identity
                                    across digital, print, and social platforms, improving clarity and visual cohesion.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Ready-to-use digital assets including social profile graphics, favicons, and app
                                    icons—allowing fast deployment while maintaining consistent brand standards.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Brand-led motion graphics, animations, and short-form video assets designed to
                                    capture attention and reinforce brand positioning across digital channels.
                                </p>
                            </div>
                        </div>
                    </div>
