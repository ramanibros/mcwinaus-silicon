        ...
        <Col md={6} className="order-md-2">
          <div className="pe-xl-5 me-md-2 me-lg-4">
            ...
            <p className="mb-3 mb-sm-4">
              Visual identity design that supports business growth—not just aesthetics. Our Perth-based team takes a strategic approach to design, ensuring every visual decision supports clarity, consistency, and commercial outcomes.
            </p>
            <ul className="list-unstyled mb-0">
              <li className="d-flex mb-2">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
                Nationwide Design Precision
              </li>
              <li className="d-flex mb-2">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
                Distinctive, competitor-aware visuals
              </li>
              <li className="d-flex">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
