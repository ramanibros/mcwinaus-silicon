...
const Description = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            // Title animation for "Offer" word - FASTER
            ...
            // Animation for step numbers - OPTIMIZED
            if (stepRefs.current.length > 0) {
                const stepNumbers = stepRefs.current.filter(Boolean) as HTMLDivElement[];

                // Use a single ScrollTrigger for all steps for better performance
                const stepsContainer = document.querySelector('.steps');

                if (stepsContainer) {
                    // Animate step numbers with stagger - FASTER
                    ...
                    <div className="steps steps-sm">
                        ...
                        >
                            ...
                            <div className="step-body">
                                ...
                                <p className="mb-0">
                                    Clear, step-by-step implementation guidance that ensures your brand strategy is
                                    applied consistently across all touchpoints, from launch to scale.
                                </p>
                            </div>
                        </div>
                    </div>
