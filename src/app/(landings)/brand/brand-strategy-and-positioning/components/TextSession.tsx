      ...
      <Row className="align-items-lg-center pt-md-3 pb-5 mb-2 mb-lg-4 mb-xl-5">
        ...
        <Col md={6} className="order-md-2">
          <div className="pe-xl-5 me-md-2 me-lg-4">
            <h2 className="h1 mb-3 mb-sm-4">Australia's Smartest Brand Positioning</h2>
            ...
            <ul className="list-unstyled mb-0">
              <li className="d-flex mb-2">
                ...
                ustralia-wide market expertise
              </li>
              <li className="d-flex mb-2">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
Competitor-led strategic intelligence              </li>
              <li className="d-flex">
                <IconifyIcon icon="bx:check" className="text-primary lead me-2" />
Profit-focused brand positioning              </li>
            </ul>
          </div>
        </Col>
      </Row>
