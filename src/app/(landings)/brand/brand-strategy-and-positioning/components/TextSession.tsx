        ...
        <Row className="align-items-center g-5">
          <Col md={6} className="mb-4 mb-md-0">
            <div ref={imageRef} className="image-frame">
              <Image src={image02} alt="Smartest Brand Positioning" className="img-fluid" />
            </div>
          </Col>
          ...
          <Col md={6}>
            <div className="content-wrap">
              ...
              <ul className="feature-list">
                {[
                  {
                    icon: "mdi:earth-arrow-right", // For Australia-wide market expertise
                    text: "Australia-wide market expertise",
                  },
                  {
                    icon: "mdi:shield-sword-outline", // For Competitor-led strategic intelligence
                    text: "Competitor-led strategic intelligence",
                  },
                  {
                    icon: "mdi:trending-up", // For Profit-focused brand positioning
                    text: "Profit-focused brand positioning",
                  },
                ].map((item, i) => (
                  <li
                    key={i}
