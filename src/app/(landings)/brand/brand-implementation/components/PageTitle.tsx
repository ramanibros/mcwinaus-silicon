            ...
            <span style={{display: 'inline-block'}}>
              ...
              {brandWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Turn brand strategy into consistent, real-world execution across every customer touchpoint. Our
                        Perth-based team ensures your positioning is applied clearly and accurately, supporting stronger
                        engagement, trust, and measurable revenue growth across Australia.
                    </p>
