          ...
          <div className="steps steps-sm">
            <div className="step">
              ...
              <div className="step-body">
                ...
                <p className="mb-0">
                  Your brand strategy embedded across every page—hero sections, CTAs, and messaging
                  fully aligned to deliver up to 3× stronger trust signals that turn first-time
            ...
            <div className="step">
              ...
              <div className="step-body">
                ...
                <p className="mb-0">
                  Brand-perfect email templates, newsletters, and ad creatives—cutting production
                  time by up to 50% while significantly improving open rates and click-through
                  performance.
                </p>
              </div>
            </div>
            ...
            <div className="step">
              ...
              <div className="step-body">
                ...
                <p className="mb-0">
                  Implementation of essential digital assets such as favicons, app icons, and
                  browser visuals—ensuring a polished and professional brand presence across all
            ...
            <div className="step">
              ...
              <div className="step-body">
                ...
                <p className="mb-0">
                  Clear and practical brand guidelines that enable internal teams and external partners to apply your brand consistently, reducing misalignment and protecting long-term brand equity.
                </p>
              </div>
            </div>
            ...
            <div className="step">
              ...
              <div className="step-body">
                ...
                <p className="mb-0">
                  Setup of performance tracking dashboards to monitor brand impact, including engagement, conversion behaviour, and key implementation metrics—providing visibility into ongoing ROI.
                </p>
              </div>
            </div>
          </div>
