...
const PageTitle = () => {
    ...
    // Split "Every Click" into individual words
    const clickWords = "Every Click".split(' ');
            ...
            >
              ...
              {clickWords.map((word, index) => (
                ...
                <Col lg={6} xl={5} className="offset-xl-1 pt-3 pt-sm-4 pt-lg-3">
                    ...
                    >
                        Strategic UI/UX design for Australian digital products, built to reduce friction and improve
                        conversion performance across web and mobile. Our Perth-based team focuses on usability,
                        clarity, and measurable outcomes—so every interaction works harder for your business.
                    </p>
