...
const faqs: FaqType[] = [
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Clear, intuitive experiences reduce friction, increase user confidence, and support higher
                    conversion and retention rates—especially for digital products competing in crowded markets
                </p>
            </>
        ),
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Yes. We design responsive web experiences and native-optimised interfaces for both iOS and Android,
    ...
    },
    {
        ...
        answer: (
            <>
                <p className="mb-0">
                    Yes. We conduct UX audits to identify friction points, then redesign flows and interfaces to improve
                    usability and performance without unnecessary rebuilds.
                </p>
            </>
        ),
    },
