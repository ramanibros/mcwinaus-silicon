    ...
    const steps = [
        {
            ...
            description: "User journey mapping and wireframing that identifies key user actions, drop-off points, and opportunities for improvement—resulting in clearer flows and improved task completion across web and mobile experiences."
        },
        {
            icon: <FiSmartphone size={24} />,
            title: "Mobile App UI Design",
            description: "Intuitive iOS and Android interface design aligned with platform guidelines, improving usability, engagement, and long-term user retention through familiar, native-feeling experiences."
        },
        {
            icon: <MdOutlineWeb size={24} />,
            title: "Landing Page UX",
            description: "Conversion-focused landing page UX designed to guide users towards a single, clear action. Strategic layout, content hierarchy, and CTA placement help reduce bounce rates and improve lead quality from Australian traffic."
        },
        {
            icon: <FiUserCheck size={24} />,
            title: "Onboarding Flow Design",
            description: "Seamless first-use experiences engineered for activation—boosting completion rates by up to 40% while creating addictive interfaces that drive immediate value and long-term engagement."
        },
        {
            icon: <FiImage size={24} />,
            title: "App Icons & Creatives",
            description: "Thumb-stopping app icons and promotional creatives—driving up to 3× more downloads with visuals perfectly aligned to your brand positioning across app stores and social profiles."
        }
    ];
                            ...
                            >
                                ...
                                <CardBody className="position-relative z-2 p-4">
                                    ...
                                    <p className="text-muted mb-4">
                                        Complete UX/UI design solution for businesses ready to create exceptional digital experiences that drive engagement and conversions.
                                    </p>
                                    
                                    <div className="mb-4">
                                        {[
                                            { icon: <MdOutlineAnalytics />, text: "Project Discovery & UX Research" },
                                            { icon: <MdOutlineDesignServices />, text: "Information Architecture & UX Design" },
                                            { icon: <MdOutlineDashboard />, text: "UI Design (High-Fidelity Screens)" },
                                            { icon: <FiSmartphone />, text: "Clickable Prototype" },
                                            { icon: <MdOutlineTrendingUp />, text: "Handoff to Dev" }
                                        ].map((item, index) => (
