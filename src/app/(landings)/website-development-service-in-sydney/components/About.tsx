                ...
                <Row className="pt-xl-3">
                    <Col md={5} className="text-center text-md-start pb-5">
                        ...
                        <p className="fs-lg justify-txt">
                            Every McWIN iTECH website launches fully SEO-optimized for Sydney dominance:
                        </p>
                        <p><strong> Technical SEO Sydney: </strong></p>
                        <ul>
                            <li>On-Page SEO – H1-H6 optimization, meta tags Sydney, internal linking</li>
                            <li>Schema Markup – LocalBusiness, Organization, FinancialService schemas</li>
                ...
                <Row>
                    <Col xs={12}>
                        <div className="pricing-section">
                            ...
                            <p>Transparent Sydney web development pricing with no hidden fees:</p>
                                ...
                                <table className="table table-bordered pricing-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$5,000 – $10,000</td>
                                            <td>2–4 weeks</td>
                                            <td>Sydney startups, local businesses</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Custom Website</strong></td>
                                            <td>$10,000 – $25,000</td>
                                            <td>4–8 weeks</td>
                                            <td>Fintech companies, eCommerce</td>
                                        </tr>
                                        <tr>
                                            <td><strong>SaaS Platform</strong></td>
                                            <td>$20,000 – $50,000+</td>
                                            <td>6–12 weeks</td>
                                            <td>SaaS startups Sydney, subscription apps</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Enterprise Solutions</strong></td>
                                            <td>$50,000+</td>
                                            <td>12+ weeks</td>
                                            <td>Large enterprises NSW, complex systems</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="mt-4 mb-0">
                                <strong>Includes:</strong> Free SEO audit, Sydney keyword research, 3 months support, performance guarantee.
                            </p>
                        </div>
                    </Col>
                </Row>
