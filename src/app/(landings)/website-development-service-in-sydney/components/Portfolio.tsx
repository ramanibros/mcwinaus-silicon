...
const testimonials = [
    {
        ...
        text:
            ...
            '<font><strong>Client:</strong> Sydney-based analytics SaaS</font><br/>' +
            '<font><strong>Challenge:</strong> Poor SEO rankings, slow mobile performance, subscription churn</font><br/>' +
            '<font><strong>Solution:</strong> Next.js PWA, Stripe integration, Sydney SEO strategy</font><br/>' +
            '<font><strong>Results:</strong> +220% organic traffic, +150% leads, 65% churn reduction in 3 months</font>' +
            '</div>',
        name: 'Sydney SaaS Startup Success',
        role: 'Live: #3 Google for "SaaS analytics Sydney" | 12K monthly visits',
        bg: testi1,
    }
]
