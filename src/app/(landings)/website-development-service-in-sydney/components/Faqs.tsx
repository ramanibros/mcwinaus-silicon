...
const faqs: FaqType[] = [
    {
        question: 'How much does web development cost in Sydney?',
        answer: (
            <>
                <p>
                    $5K-$50K+ based on complexity. Business sites $5K-10K, SaaS platforms $20K+, Enterprise $50K+.
                </p>
            </>
        ),
    },
    {
        question: 'How long does web development take in Sydney?',
        answer: (
            <>
                <p>
                    2-12 weeks. Basic sites 2-4 weeks, custom Fintech/SaaS 6-12 weeks.
                </p>
            </>
        ),
    },
    {
        question: 'Do you offer Sydney SEO services?',
        answer: (
            <>
                <p>
                    Every project includes comprehensive Sydney SEO – on-page, technical, local optimization.
                </p>
            </>
        ),
    },
    {
        question: 'Are your Fintech solutions compliant?',
        answer: (
            <>
                <p>
                    Fully ASIC/APRA compliant with PCI DSS, KYC/AML, GDPR-ready architecture.
                </p>
            </>
        ),
    },
    {
        question: 'What makes you different from other Sydney agencies?',
        answer: (
            <>
                <p>
                    Sydney-local team, Fintech expertise, proven SEO results, transparent pricing, performance guarantees.
                </p>
            </>
        ),
    }
