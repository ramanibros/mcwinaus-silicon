      ...
      <Container>
        <Row>
          <Col xs={12} xl={3} className="pb-sm-2 pb-md-3 mb-lg-5 mb-xl-0">
            ...
            <p
              className="fs-sm pb-lg-3 justify-txt"
              style={{ paddingBottom: '0', marginBottom: '0' }}
            >
              McWIN iTECH – Perth's local growth partner delivering award-winning websites, SEO &
              apps that increase conversions and build trust with Australian customers.
            </p>

            <div className="mt-n3 ms-n3">
              <a className="mt-3 ms-3 d-inline-block" href="#" data-discover="true">
                <Image style={{ width: '60px' }} alt="Meta" src={meta} />
              </a>

              <a className="mt-3 ms-3 d-inline-block" href="#" data-discover="true">
                <Image style={{ width: '80px' }} alt="Google" src={google} />
              </a>

              <a className="mt-3 ms-3 d-inline-block" href="#" data-discover="true">
                <Image style={{ width: '80px' }} alt="Clutch" src={clutch} />
              </a>
            </div>
          </Col>
            ...
            {resources.map((resource, index) => (
              <div key={index} className="position-relative d-flex align-items-center py-2 my-1">
                ...
                <div className="nav flex-column ps-3">
                  ...
                  <a href={resource.link} className="nav-link fw-bold stretched-link p-0">
                    {resource.title}
                  </a>
